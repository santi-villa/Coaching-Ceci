...
const modalData = {
            ...
            <form id="checkout-form" onsubmit="handleCheckout(event)">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6 shadow-sm">
                    ...
                    <div id="shipping-fields" class="space-y-4 pt-4 mt-2 border-t border-gray-200">
                        ...
                        <p id="shipping-error-message" class="hidden text-sm text-red-500 font-medium"></p>
                        ...
                        <div class="mt-4 flex items-center justify-between border border-brand-lilac/30 rounded-xl p-3 bg-brand-pink/5 shadow-sm">
                            ...
                            <button type="button" data-action="calculate-shipping" id="btn-calc-shipping" class="bg-white border border-brand-lilac text-brand-lilac px-4 py-2 rounded-lg text-xs md:text-sm font-semibold hover:bg-brand-lilac hover:text-white transition shadow-sm">Cotizar Envío</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-5 mt-2 bg-brand-light/30 p-3 rounded-xl border border-brand-lilac/30">
                    <label class="flex items-start space-x-3 cursor-pointer">
                        ...
                        <span class="text-xs text-gray-600 leading-snug">
                            He leído y acepto las <a href="#legales" data-action="open-legales-from-modal" class="text-brand-lilac font-bold hover:underline">Políticas de Privacidad</a> y autorizo el tratamiento de mis datos de envío.
                        </span>
                    </label>
                </div>
                ...
                <div class="mt-4 text-center">
                    <button type="button" data-action="close-modal" class="text-gray-500 hover:text-brand-text text-sm font-medium transition flex items-center justify-center gap-1 mx-auto">
    ...
    read: {
        ...
        content: `
            ...
            <button data-action="read-more-product" class="mt-4 w-full bg-brand-lilac text-white py-3 rounded-xl font-medium hover:bg-opacity-90 transition shadow-sm">Ver detalles del libro para seguir leyendo</button>
        `
    },
    success: {
        ...
        content: `
            <div class="text-center py-4">
                ...
                <button data-action="close-modal" class="w-full bg-brand-text text-white py-4 rounded-xl font-medium hover:bg-opacity-90 transition shadow-lg">Entendido ✓</button>
            </div>
        `
    },
    subscribe: {
